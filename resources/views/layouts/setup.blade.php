...
<header class="u-header">
    <div class="u-header-left border-right-0">
        <a class="u-header-logo" href="index.html">
            <img class="u-logo-desktop" src="./assets/img/logo-app.png" width="160" alt="Stream Dashboard">
        ...
        <div class="u-sidebar-inner">
            <header class="u-sidebar-header">
                <a class="u-sidebar-logo" href="index.html">
                    <img class="img-fluid" src="./assets/img/logo-app.png" width="124" alt="Stream Dashboard">
                </a>
            </header>
