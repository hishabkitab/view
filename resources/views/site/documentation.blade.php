            ...
            <div class="sidebar-body">
                <ul class="sidebar-nav">
                    ...
                    <li class="nav-item"><a href="index.html" class="nav-link"><i data-feather="layout"></i>
                            Introduction</a></li>
                    <li class="nav-item"><a href="grid.html" class="nav-link active"><i data-feather="grid"></i> Grid
                            System</a>
                    </li>
        ...
        <div class="content content-components">
            <div class="container">
                ...
                <p class="mg-b-30">Bootstrap’s grid system uses a series of containers, rows, and columns to layout and
                    align content. It’s built with flexbox and is fully responsive. Below is an example and an in-depth
                    look
...
&lt;/div&gt;</code></pre>
                ...
                <p class="mg-b-30">Auto-layout for flexbox grid columns also means you can set the width of one column
                    and
...
&lt;/div&gt;</code></pre>
                ...
                <p class="mg-b-30">Gutters can be responsively adjusted by breakpoint-specific padding and negative
                    margin
                    utility classes.</p>
...
&lt;div class="row row-xs"&gt;...&lt;/div&gt;</code></pre>
                ...
                <p class="mg-b-30">The gutters between columns in our predefined grid classes can be removed with <code>.no-gutters</code>.
                    This removes the negative margins from <code>.row</code> and the horizontal padding from all
                    immediate
                    children columns.</p>
                ...
                <p class="mg-b-30">Use <code>.order-</code> classes for controlling the visual order of your content.
                </p>
